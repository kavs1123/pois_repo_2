...
function KBadge({ K, label }) {
    return (
        <div style={{
            marginTop: '8px', padding: '8px 12px', borderRadius: 'var(--radius-md)',
...
function StepIndicator({ step }) {
    ...
    return idx > 0 ? (
        <div style={{
            textAlign: 'center', fontSize: '0.75rem', color: 'var(--accent-cyan)',
    ...
    return (
        <div style={{ padding: '0 2px' }}>
            ...
            <div style={{ ...S.panel }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '12px', alignItems: 'start' }}>
                    ...
                    <div style={{ padding: '12px', background: 'rgba(0,229,255,0.04)', borderRadius: 'var(--radius-md)', border: '1px solid rgba(0,229,255,0.15)' }}>
                        ...
                        <div style={{ display: 'flex', gap: '6px', marginBottom: '8px' }}>
                            <div style={{
                                flex: 1, ...S.mono, fontSize: '0.69rem', padding: '5px 8px',
                        ...
                        <div style={{
                            ...S.mono, fontSize: '0.69rem', padding: '5px 8px',
                            background: 'var(--bg-glass)', borderRadius: 'var(--radius-md)',
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', paddingTop: '32px' }}>
                        {/* Arrow Alice→Bob */}
                        <div style={{
                            fontSize: '0.65rem', textAlign: 'center', ...S.dim, transition: 'opacity 0.4s',
                ...
                {step === 'done' && (
                    <div style={{
                        marginTop: '12px', padding: '10px 14px', borderRadius: 'var(--radius-md)', textAlign: 'center',
                ...
                {cdhResult && (
                    <div style={{ ...S.mono }}>
                        {cdhResult.found ? (
                            <>
                                <div style={{
                                    padding: '8px 12px', background: 'rgba(34,197,94,0.08)', borderRadius: 'var(--radius-md)',
            ...
            <div style={S.panel}>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '12px' }}>
                    ...
                    {genResult && (
                        <Btn onClick={() => {
                            setParams({ p: genResult.p, q: genResult.q, g: genResult.g });
                            setStep('idle'); setKAlice(null); setKBob(null); setA(null); setA_(null); setB(null); setB_(null);
                        }} color="#22c55e">
