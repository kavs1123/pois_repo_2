  ...
  return (
    <div style={{ marginBottom:'10px' }}>
      ...
      <div style={{ display:'flex', flexWrap:'wrap', gap:'2px' }}>
        {bytes.map((b, i) => (
          <div key={i} style={{ padding:'2px 4px', borderRadius:'3px', ...S.mono, fontSize:'0.61rem',
  ...
  return (
    <div style={{ padding:'0 2px' }}>
      ...
      <div style={S.panel}>
        ...
        {enc1 && enc2 && (
          <div style={{ marginTop:'14px' }}>
            <div style={{ padding:'10px 14px', borderRadius:'var(--radius-md)', marginBottom:'12px',
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'10px', marginBottom:'12px' }}>
              {[enc1, enc2].map((enc, i) => (
                <div key={i} style={{ padding:'8px 10px', background:'var(--bg-glass)',
                  borderRadius:'var(--radius-md)', border:'1px solid var(--border-subtle)' }}>
                  <div style={{ fontSize:'0.68rem', ...S.dim, marginBottom:'4px', fontWeight:600 }}>Ciphertext #{i+1}</div>
                  <div style={{ ...S.mono, fontSize:'0.67rem', wordBreak:'break-all',
                    color: identical ? '#ef4444' : '#22c55e' }}>
                    {hex(enc.c, 40)}
                  </div>
                </div>
            ...
            {mode === 'pkcs15' && enc1.em && (
              <div style={{ padding:'10px 12px', background:'var(--bg-glass)',
                borderRadius:'var(--radius-md)', border:'1px solid var(--border-subtle)' }}>
      ...
      <div style={S.panel}>
        ...
        <div style={{ padding:'8px 12px', marginBottom:'12px', borderRadius:'var(--radius-md)',
        ...
        {bSetup?.em && (
          <div style={{ padding:'8px 10px', background:'var(--bg-glass)', borderRadius:'var(--radius-md)',
        ...
        {/* Progress log */}
        {bLog.length > 0 && (
          <div style={{ padding:'8px 10px', background:'var(--bg-glass)',
            borderRadius:'var(--radius-md)', border:'1px solid var(--border-subtle)',
